...
public class RestCallResponse {
    ...
    public static com.shree.varikolepahani.network.RestCallResponse convertJson(String data) {
        try {
            Gson gson = new Gson();
            com.shree.varikolepahani.network.RestCallResponse restCallResponse = gson.fromJson(data, com.shree.varikolepahani.network.RestCallResponse.class);
